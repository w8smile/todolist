...
test('correct todolist should be removed', () => {
  const endState = todolistReducer(startState, todolistsActions.removeTodolist({id: todolistId1}))
...
test('correct todolist should be added', () => {
  ...
  const endState = todolistReducer(startState, todolistsActions.addTodolist({todolist}))
